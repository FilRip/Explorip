...
internal class UdtWrapper
{
    ...
    /// </summary>
    private readonly Type m_udtType;
...
#pragma warning restore S3011
        ...
        foreach (YaxBaseAttribute attr in m_udtType.GetCustomAttributes(true).OfType<YaxBaseAttribute>())
        {
    ...
    public BindingFlags Portee { get; set; }
    /// <summary>
    ...
    private void ProcessYAXAttribute(object attr)
    {
        ...
        {
            throw new YaxException("Attribute not applicable to types!");
        }
    }
}
