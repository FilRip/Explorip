...
#pragma warning restore CS8618
    ...
    protected override bool ParseSectionContent(BinaryReader binaryReader)
    {
        ...
        {
            binaryReader.ReadUInt16();
            EQualifierType qualifierType = (EQualifierType)binaryReader.ReadUInt16();
            binaryReader.ReadUInt16();
            binaryReader.ReadUInt16();
    ...
    private record struct DistinctQualifierInfo(EQualifierType QualifierType, uint OperandValueOffset);
}
