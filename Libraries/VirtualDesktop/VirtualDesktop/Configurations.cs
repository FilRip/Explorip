...
public class VirtualDesktopCompilerConfiguration
{
    /// <summary>
    ...
    /// </returns>
    public bool SaveCompiledAssembly { get; set; } = true;
    ...
    /// </returns>
    public DirectoryInfo CompiledAssemblySaveDirectory { get; set; } = new DirectoryInfo(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "assemblies"));

    public void ChangeDirectory(string company, string application, string subFolder)
    {
