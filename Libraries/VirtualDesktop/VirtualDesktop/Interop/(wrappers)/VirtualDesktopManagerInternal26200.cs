...
{
    [ComInterfaceWrapper("IVirtualDesktopManagerInternal", 26200)]
    internal sealed class VirtualDesktopManagerInternal26200(ComInterfaceAssembly assembly) : VirtualDesktopManagerInternal(assembly)
    {
