...
{
    [ComInterfaceWrapper("IVirtualDesktopManagerInternal", 26100)]
    internal sealed class VirtualDesktopManagerInternal26100(ComInterfaceAssembly assembly) : VirtualDesktopManagerInternal(assembly)
    {
