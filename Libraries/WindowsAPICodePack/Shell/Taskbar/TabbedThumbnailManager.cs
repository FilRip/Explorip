...
public class TabbedThumbnailManager
{
    ...
    public TabbedThumbnail GetThumbnailPreview(IntPtr windowHandle)
    {
        ...
        return _tabbedThumbnailCache.TryGetValue(windowHandle, out TabbedThumbnail thumbnail) ? thumbnail : null;
    }
    ...
    public TabbedThumbnail GetThumbnailPreview(UIElement windowsControl)
    {
        ...
        return _tabbedThumbnailCacheWPF.TryGetValue(windowsControl, out TabbedThumbnail thumbnail) ? thumbnail : null;
    }
