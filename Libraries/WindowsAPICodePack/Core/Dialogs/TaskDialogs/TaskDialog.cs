...
using Microsoft.WindowsAPICodePack.Interop.TaskDialogs;
...
public sealed class TaskDialog : IDialogControlHost, IDisposable
{
    ...
    {
        foreach (TaskDialogButton control in controls.OfType<TaskDialogButton>())
        {
    ...
    {
        return (TaskDialogNativeMethods.TaskDialogCommonButtonReturnIds)id switch
        {
    ...
    {
        HyperlinkClick?.Invoke(this, new TaskDialogHyperlinkClickedEventArgs(link));
    }
