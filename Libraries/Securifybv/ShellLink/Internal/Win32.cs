...
namespace Securify.ShellLink.Internal
{
    ...
    internal static class Win32
    {
        ...
        internal static extern bool SHGetPathFromIDListW(byte[] pidl, byte[] pszPath);
        ...
        /// <returns></returns>
        [DllImport("shell32.dll")]
        internal static extern int SHGetKnownFolderIDList([MarshalAs(UnmanagedType.LPStruct)] Guid rfid, uint dwFlags, IntPtr hToken, out IntPtr ppidl);
