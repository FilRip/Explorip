...
public class VolumeID(bool IsUnicode) : Structure()
{
    ...
    public static VolumeID FromByteArray(byte[] ba)
    {
        ...
        if (volumeLabelOffset == 0x14)
        {
            ...
            VolumeId.VolumeLabel = Encoding.Unicode.GetString(data).TrimEnd((char)0);
        ...
        else
        {
            ...
            VolumeId.VolumeLabel = Encoding.Default.GetString(data).TrimEnd((char)0);
        }
        return VolumeId;
    }
