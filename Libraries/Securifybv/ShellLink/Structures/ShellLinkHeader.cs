...
namespace Securify.ShellLink.Structures
{
    ...
    public class ShellLinkHeader : Structure
    {
        ...
        /// </summary>
        public readonly Guid LinkCLSID = new("00021401-0000-0000-C000-000000000046");
        ...
        public static ShellLinkHeader FromByteArray(byte[] ba)
        {
            ...
            Header.LinkFlags = (ELink)BitConverter.ToUInt32(ba, 20);
            Header.FileAttributes = (EFileAttributes)BitConverter.ToUInt32(ba, 24);
