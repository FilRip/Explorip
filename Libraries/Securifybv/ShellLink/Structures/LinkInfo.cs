...
namespace Securify.ShellLink.Structures
{
    ...
    public class LinkInfo : Structure
    {
        ...
        public uint LinkInfoHeaderSize
        {
            ...
            {
                uint Size = 0x1C;
                if (LinkInfoFlags.HasFlag(ELinkInfo.VolumeIDAndLocalBasePath) && LocalBasePathUnicode != null)
                {
                    Size += 4;
                }
                if (LinkInfoFlags.HasFlag(ELinkInfo.CommonNetworkRelativeLinkAndPathSuffix) && CommonPathSuffixUnicode != null)
                {
                    Size += 4;
                }
                return Size;
        ...
        /// </summary>
        public ELinkInfo LinkInfoFlags => (VolumeID != null ? ELinkInfo.VolumeIDAndLocalBasePath : 0) | (CommonNetworkRelativeLink != null ? ELinkInfo.CommonNetworkRelativeLinkAndPathSuffix : 0);
        ...
        public uint LocalBasePathOffsetUnicode
        {
            get
            {
                if (LocalBasePathUnicode != null && VolumeID != null)
                {
                    if (CommonNetworkRelativeLink != null)
                    {
        ...
        public static LinkInfo FromByteArray(byte[] ba)
        {
            ...
            ELinkInfo linkInfoFlags = (ELinkInfo)BitConverter.ToUInt32(ba, 8);
