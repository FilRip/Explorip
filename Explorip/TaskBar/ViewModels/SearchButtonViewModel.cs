...
public partial class SearchButtonViewModel : ObservableObject
{
    ...
    private void ShowSearch()
    {
        ...
        if (currentTaskbar != null)
        {
            ...
            NativeMethods.SetWindowPos(ptrForegroundWindow, IntPtr.Zero, (int)currentTaskbar.Left, (int)currentTaskbar.Top - rect.Height, rect.Width, rect.Height, NativeMethods.SWP.SWP_SHOWWINDOW);
        }
    }
}
